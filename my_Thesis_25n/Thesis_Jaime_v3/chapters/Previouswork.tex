...
.\TODO{review that the label sec:Nicostuff is not mentioned in anything related to the now called: "Controll approaches"}
...
and resulting injury was formulated. With this injury knowledge an algorithm was developed to limit the velocity of the end-effector to ensure safe motions. This safety velocity controller \TODO{check everywhere safety velocity and not safe velocity} is named Safe Motion Unit (SMU). 
